...
The Runbook is free, it is provided as is, it is not affiliated with Microsoft,
and it is not a substitute for hands-on practice in a real Azure subscription.
...
Sharing real exam content violates the certification agreement you sign before
sitting an exam. If you believe any scenario here reproduces live exam material,
report it through the issue tracker and it will be rewritten.

## Cost

The game is free in full. There are no payments, no subscriptions, and no part of
the content is held back behind one.
...
ownership can be reasonably established. Accounts used for abuse, automated
scraping or attempts to break the service may be removed without notice.

## No warranty

The game is provided as is, without warranty of any kind. Passing or failing a
certification exam is your own outcome and no liability is accepted for it. The
service may be unavailable, may lose data, and may change or end at any time.
